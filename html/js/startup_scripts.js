...
var plot_Layer_tfl_sites = L.geoJSON(tfl_sites, {
  style:tfl_sites_Style,
  onEachFeature:onEachFeature
});

var plot_Layer_tfl_plots_gsi = L.geoJSON(tfl_plots, {
  style:style_gsi,
  onEachFeature:onEachFeature
});

var plot_Layer_tfl_plots_far = L.geoJSON(tfl_plots, {
  style:style_far,
  onEachFeature:onEachFeature
});
...
L.control.navbar({zoom:14}).addTo(map);
